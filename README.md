...
2 | 3-2 | Link to `commit #1 from Github.com` | [commit #1](https://github.com/matthewpearso/git-milestones)
3 | 3-3 | Link to markdown tables docs | [markdown tables docs](https://docs.github.com/en/get-started/writing-on-github/working-with-advanced-formatting/organizing-information-with-tables)
4 | 3-4 | What does `log` do? | Shows you the history of your commits
...
9 | 6-1 | Link to `first-website` github.com repo page | [repo page](https://github.com/matthewpearso/cwd-first-website)
10 | 7-1 | Link to `first-website` github.io "project site" | [project site](https://matthewpearso.github.io/cwd-first-website/)
...
14 | 11-1 | Link to the PR you made on a partner's github.com repo | [pull request link](https://github.com/delila-cruz/first-website/pull/1)
